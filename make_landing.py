...
ENTRIES = [
 ("catalog", "Training data catalog (start here)", "124 obtainable public datasets (no benchmark eval splits, no unreleased data) for training a streaming visual interaction model: size, video domains, what people do in the videos, the annotations on each video and who made them, access and license, grouped by the capability they teach."),
